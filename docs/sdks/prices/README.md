...
try {
    ...
    $request->trialPeriod->frequency = 796474;
    $request->trialPeriod->interval = Period2Interval::Week;
    $request->unitPrice = new Money2();
    $request->unitPrice->amount = '951.07';
    $request->unitPrice->currencyCode = CurrencyCode2::Twd;
