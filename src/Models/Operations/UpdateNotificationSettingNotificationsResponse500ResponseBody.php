...
/**
 * UpdateNotificationSettingNotificationsResponse500ResponseBody - General error response
 * 
 * @package paddle\Paddle\Models\Operations
 * @access public
 */
class UpdateNotificationSettingNotificationsResponse500ResponseBody
{
