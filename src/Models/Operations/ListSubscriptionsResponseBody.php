...
/**
 * ListSubscriptionsResponseBody - OK
 * 
 * @package paddle\Paddle\Models\Operations
 * @access public
 */
class ListSubscriptionsResponseBody
{
    /**
     * $data
     * 
     * @var array<\paddle\Paddle\Models\Shared\Subscription1> $data
     */
	#[\JMS\Serializer\Annotation\SerializedName('data')]
    #[\JMS\Serializer\Annotation\Type('array<paddle\Paddle\Models\Shared\Subscription1>')]
    public array $data;
