...
/**
 * ListNotifications200ApplicationJSON - OK
 * 
 * @package paddle\Paddle\Models\Operations
 * @access public
 */
class ListNotifications200ApplicationJSON
{
    /**
     * $data
     * 
     * @var array<\paddle\Paddle\Models\Shared\Notification> $data
     */
	#[\JMS\Serializer\Annotation\SerializedName('data')]
    #[\JMS\Serializer\Annotation\Type('array<paddle\Paddle\Models\Shared\Notification>')]
    public array $data;
