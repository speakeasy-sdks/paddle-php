...
/**
 * PreviewSubscriptionSubscriptionPreview - Represents a subscription preview.
 * 
 * @package paddle\Paddle\Models\Operations
 * @access public
 */
class PreviewSubscriptionSubscriptionPreview
{
    /**
     ...
     * 
     * @var ?\paddle\Paddle\Models\Operations\PreviewSubscriptionDiscount $discount
     */
	#[\JMS\Serializer\Annotation\SerializedName('discount')]
    #[\JMS\Serializer\Annotation\Type('paddle\Paddle\Models\Operations\PreviewSubscriptionDiscount')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?PreviewSubscriptionDiscount $discount = null;
    ...
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?\paddle\Paddle\Models\Shared\SchemaStatusSubscription $status = null;
