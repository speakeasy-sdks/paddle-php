...
/**
 * GetIpAddressesResponseBody - OK
 * 
 * @package paddle\Paddle\Models\Operations
 * @access public
 */
class GetIpAddressesResponseBody
{
	#[\JMS\Serializer\Annotation\SerializedName('data')]
    #[\JMS\Serializer\Annotation\Type('paddle\Paddle\Models\Operations\Data')]
    public Data $data;
	...
	{
		$this->data = new \paddle\Paddle\Models\Operations\Data();
