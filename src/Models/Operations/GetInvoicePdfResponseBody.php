...
/**
 * GetInvoicePdfResponseBody - OK
 * 
 * @package paddle\Paddle\Models\Operations
 * @access public
 */
class GetInvoicePdfResponseBody
{
	#[\JMS\Serializer\Annotation\SerializedName('data')]
    #[\JMS\Serializer\Annotation\Type('paddle\Paddle\Models\Operations\GetInvoicePdfData')]
    public GetInvoicePdfData $data;
	...
	{
		$this->data = new \paddle\Paddle\Models\Operations\GetInvoicePdfData();
