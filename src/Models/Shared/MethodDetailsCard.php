...
/**
 * MethodDetailsCard - Information about the credit or debit card used to pay. Only returned when `type` is `card`.
 * 
 * @package paddle\Paddle\Models\Shared
 * @access public
 */
class MethodDetailsCard
{
    /**
     ...
     * 
     * @var ?\paddle\Paddle\Models\Shared\MethodDetailsCardType $type
     */
	#[\JMS\Serializer\Annotation\SerializedName('type')]
    #[\JMS\Serializer\Annotation\Type('enum<paddle\Paddle\Models\Shared\MethodDetailsCardType>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?MethodDetailsCardType $type = null;
