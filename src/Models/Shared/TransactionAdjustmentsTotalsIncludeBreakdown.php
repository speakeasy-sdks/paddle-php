...
/**
 * TransactionAdjustmentsTotalsIncludeBreakdown - Breakdown of the total adjustments by adjustment action.
 * 
 * @package paddle\Paddle\Models\Shared
 * @access public
 */
class TransactionAdjustmentsTotalsIncludeBreakdown
{
    /**
