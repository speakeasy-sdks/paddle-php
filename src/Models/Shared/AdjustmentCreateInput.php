...
/**
 * AdjustmentCreateInput - Represents an adjustment entity.
 * 
 * @package paddle\Paddle\Models\Shared
 * @access public
 */
class AdjustmentCreateInput
{
    /**
     ...
     * 
     * @var array<\paddle\Paddle\Models\Shared\AdjustmentCreateAdjustmentItemInput> $items
     */
	#[\JMS\Serializer\Annotation\SerializedName('items')]
    #[\JMS\Serializer\Annotation\Type('array<paddle\Paddle\Models\Shared\AdjustmentCreateAdjustmentItemInput>')]
    public array $items;
	...
	{
		$this->action = \paddle\Paddle\Models\Shared\Schemasaction::Credit;
